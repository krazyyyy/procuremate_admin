...
type FilterAction =
  ...
  | { type: "setFilters"; payload: FilterState }
  | { type: "reset"; payload: FilterState }
  | { type: "setOffset"; payload: number }
  | { type: "setDefaults"; payload: object | null }
  | { type: "setDate"; payload: DateFilter }
  | { type: "setStatus"; payload: null |[] }
  | { type: "setFulfillment"; payload: null | [] }
  | { type: "setTags"; payload: null | [] }
...
const formatDateFilter = (filter: object) => {
  if (filter === null) {
    return filter
  }
...
export const useFilters = (
  existing?: string,
  defaultFilters: DefaultFilters | null = null
) => {
  ...
  const setDateFilter = (filter: object | null) => {
  ...
  const getRepresentationObject = (fromObject?: FilterState) => {
  ...
  const saveTab = (tabName: string, filters: FilterState) => {
    console.log("Here")
