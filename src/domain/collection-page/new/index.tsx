...
interface ExtendedAdminPostProductsReq extends AdminPostProductsReq {
  seo_title?: string;
  ...
  const onSubmit = (publish = true) =>
    handleSubmit(async (data) => {
      ...
      mutate(payload, {
        onSuccess: ({ product }) => {
          closeAndReset()
          Medusa.products.update(product.id, data.seoForm)
              ...
              <Accordion.Item title="Organize" value="organize">
                ...
                <div className="flex flex-col mt-xlarge gap-y-xlarge pb-xsmall">
                  <div>
                    ...
                    <OrganizeForm form={nestedForm(form, "organize")} type="Ready Made" />
                  </div>
                </div>
              </Accordion.Item>
