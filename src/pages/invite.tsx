                ...
                {!token ? (
                  ...
                  <>
                    ...
                    <Button
                      ...
                      size="large"
                      type="submit"
                      className="w-full mt-base bg-black hover:bg-black"
          ...
          <div className="z-10 flex-grow flex flex-col items-center justify-center h-full absolute inset-0 max-w-[1080px] mx-auto">
            <div className="flex flex-col items-center max-w-3xl text-center">
              ...
              <p className="inter-xlarge-regular text-grey-50">
                You can now join the Procuremate Store team. Sign up below and get
                started with your Procuremate Admin account right away.
              </p>
            </div>
            <div className="mt-4xlarge">
              <Button
                size="large"
                variant="primary"
                className="w-[280px] bg-black hover:bg-black"
